            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              >
                ...
                <span className="flex items-center gap-1 font-bold text-sm" style={{ color: 'var(--color-premium-green-500)' }}>
                  ...
                  {readOnly
                    ? business.cost.toLocaleString('en-US')
                    : (isLocked ? business.baseProfitPerMin : business.profitPerMin).toLocaleString('en-US') + '/min'}
                </span>
              </div>
            </div>
            ...
            {readOnly && (
              <div className="flex items-center gap-3 mt-2">
                ...
                >
                  ...
                  <span className="flex items-center gap-1 font-bold text-sm" style={{ color: 'var(--color-premium-green-500)' }}>
                    <CoinIcon className="w-4 h-4" premium />
                    {business.baseProfitPerMin.toLocaleString('en-US')}/min
                  </span>
                </div>
              </div>
            )}
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                >
                  ...
                  <span className="flex items-center gap-1 font-bold text-sm" style={{ color: 'var(--color-premium-gold-400)' }}>
                    <CoinIcon className="w-4 h-4" premium />
                    {calculateTieredProfit(business.baseProfitPerMin, business.maxLevel).toLocaleString('en-US')}/min
                  </span>
                </div>
              </div>
            )}
            ...
            {readOnly ? (
              ...
              <>
                ...
                >
                  ...
                  {isLocked ? 'Open shop' : 'Upgrade'} — ${business.cost.toLocaleString('en-US')}
                </motion.button>

                {!isAffordable && (
                  <p className="text-center text-[10px] font-bold mt-2" style={{ color: 'var(--color-premium-red-400)' }}>
                    Need ${(business.cost - cash).toLocaleString('en-US')} more
                  </p>
                )}
              </>
            )}
