...
export const PortfolioScreen: React.FC<PortfolioScreenProps> = ({
  ...
  const districtsOwned = coralBayCity.districts
  ...
  const totalBusinessesPossible = coralBayCity.districts.length * 8;
  ...
  return (
    <div id="portfolio-tab" className="p-4 space-y-4 pb-28 select-none" style={{ backgroundColor: 'var(--color-premium-bg)' }}>
      ...
      <div className="grid grid-cols-3 gap-2.5">
        ...
        <BottomStat label="Districts" value={`${districtsOwned.length} / ${coralBayCity.districts.length}`} />
      </div>
