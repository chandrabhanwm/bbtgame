    ...
    >
      <div className="flex flex-nowrap items-stretch gap-1.5">
            ...
            {editingName ? (
              ...
              <div onClick={() => { playClick(); setEditingName(true); }} className="cursor-pointer">
                ...
                <motion.div
                  ...
                  animate={xpPct >= 85 ? { boxShadow: ['0 0 0px rgba(45,212,191,0)', '0 0 6px rgba(45,212,191,0.6)', '0 0 0px rgba(45,212,191,0)'] } : {}}
        ...
        <motion.div
          ...
          style={{ boxShadow: cashPulsing ? '0 0 14px rgba(45, 212, 191, 0.5)' : undefined }}
        >
        ...
        <motion.button
          whileTap={{ scale: 0.95 }}
          onClick={onClaimPool}
          animate={stats.poolCash > 0 ? { boxShadow: ['0 0 0px rgba(45,212,191,0)', '0 0 14px rgba(45,212,191,0.6)', '0 0 0px rgba(45,212,191,0)'] } : {}}
