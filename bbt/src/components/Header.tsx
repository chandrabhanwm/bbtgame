        ...
        >
          ...
          {showProfitTapHint && stats.poolCash > 0 && (
            <>
              ...
              />
              {/* Floating "Tap to collect!" callout below the box — bold
                  and explicit, since an icon alone apparently wasn't
                  communicating clearly enough on its own. Positioned
                  below rather than above, since the Header sits at the
                  very top of the screen — a callout above the box would
                  get clipped by the screen/status bar with no room to
                  actually render. */}
              <motion.div
                className="absolute -bottom-8 left-1/2 -translate-x-1/2 px-2.5 py-1 rounded-full whitespace-nowrap pointer-events-none z-30"
