      ...
      <AnimatePresence>
        {celebrating && (
          <motion.div
            ...
            style={{
              background: 'radial-gradient(circle at 50% 40%, rgba(45,212,191,0.35), rgba(10,10,11,0.55) 70%)',
            }}
          >
            <motion.div
              className="absolute inset-0"
              style={{
                background: 'conic-gradient(from 0deg, transparent 0deg, rgba(45,212,191,0.25) 8deg, transparent 16deg, transparent 45deg, rgba(45,212,191,0.25) 53deg, transparent 61deg, transparent 90deg, rgba(45,212,191,0.25) 98deg, transparent 106deg, transparent 135deg, rgba(45,212,191,0.25) 143deg, transparent 151deg, transparent 180deg, rgba(45,212,191,0.25) 188deg, transparent 196deg, transparent 225deg, rgba(45,212,191,0.25) 233deg, transparent 241deg, transparent 270deg, rgba(45,212,191,0.25) 278deg, transparent 286deg, transparent 315deg, rgba(45,212,191,0.25) 323deg, transparent 331deg, transparent 360deg)',
              }}
              animate={{ rotate: 360 }}
