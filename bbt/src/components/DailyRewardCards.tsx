...
const ROSE = 'var(--color-premium-info-400)'; // the one non-gold, non-money accent used specifically for this component to stand out
...
export const DailyRewardCards: React.FC<DailyRewardCardsProps> = ({ cards, onScratch, onClaim, lastCardClaimAt }) => {
  ...
  const [adBrand, setAdBrand] = useState('Coral Cola Co.');
            ...
            <AnimatePresence mode="wait">
              {!card.scratched ? (
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(155deg, var(--color-premium-info-400) 0%, #12A6A3 100%)',
                ...
                >
                  {isLockedByCooldown ? (
                    <>
                      ...
                      <span className="relative text-[8.5px] font-bold text-center px-2" style={{ color: 'var(--color-premium-text-inverse)' }}>
                        Unlocks soon
                      </span>
                    </>
                  ) : (
                    <>
                      <div
                        ...
                        style={{ background: 'rgba(255,255,255,0.22)', border: '2.5px solid var(--color-premium-border-strong)' }}
                      >
                        <Gift size={22} color="var(--color-premium-text-inverse)" strokeWidth={2} />
                      </div>

                      <div className="relative flex items-center gap-1.5 px-2">
                        <div className="w-3 h-px" style={{ borderTop: '1.5px dashed rgba(255,255,255,0.7)' }} />
                        <span className="text-[9px] font-bold whitespace-nowrap" style={{ color: 'var(--color-premium-text-inverse)' }}>
            ...
            >
              ...
              <div className="p-4 bg-gradient-to-t from-black/80 to-transparent text-center relative z-10">
                <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">
                  Thank you for supporting Coral Bay Resort Tycoon!
                </span>
              </div>
            </motion.div>
          </div>
