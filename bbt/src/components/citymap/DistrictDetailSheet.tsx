          ...
          >
            ...
            {unlocked ? (
              <div className="grid grid-cols-2 gap-2 mt-3.5">
                <StatTile label="Income" value={`${Math.round(progress.income).toLocaleString('en-US')}/min`} money />
              ...
              <div className="grid grid-cols-2 gap-2 mt-3.5">
                <StatTile label="Potential Income" value={`${Math.round(potentialIncome).toLocaleString('en-US')}/min`} money />
