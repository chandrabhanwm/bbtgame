...
import {
  Anchor, Fish, Ship, Sailboat, Factory, Building2, Hospital, Store, Trees,
  Landmark, Lock, Check, LucideIcon
} from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <circle
        ...
        style={{ transition: 'stroke 0.7s ease, stroke-width 0.7s ease', filter: 'drop-shadow(0 6px 10px rgba(34,49,66,0.18))' }}
      />
      ...
      {status !== 'locked' && (
        <g transform="translate(0, 66)">
          <text textAnchor="middle" fontSize="7.5" fontWeight="600" fill="var(--color-premium-green-500)" fontFamily="Inter, sans-serif">
            ${Math.round(income).toLocaleString('en-US')}/min
          </text>
