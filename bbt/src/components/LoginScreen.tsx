...
interface LoginScreenProps {
  onSignedIn: () => void;
  /** Surfaces an error from a completed redirect-based sign-in attempt
   *  (the standalone-PWA / popup-blocked fallback) — shown the same way
   *  a direct popup failure already is, so a failed redirect doesn't
   *  leave the player on this screen with no explanation. */
