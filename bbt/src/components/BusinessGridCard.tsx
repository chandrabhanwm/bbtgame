...
export const BusinessGridCard: React.FC<BusinessGridCardProps> = ({ business, index, imageUrl, onSelect, justUpdated = false, cash }) => {
  ...
  return (
    <motion.button
      ...
      style={{
        minHeight: '156px',
        boxShadow: celebrating ? '0 0 0 2px var(--color-premium-gold-400), 0 0 16px rgba(255, 92, 122, 0.45)' : undefined,
      }}
    >
      {celebrating && (
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 2px 10px rgba(255, 92, 122,0.6)',
            }}
      ...
      <div className="relative w-full h-[64px] rounded-t-[14px] overflow-hidden flex-shrink-0">
        ...
        <motion.span
          ...
          animate={isAffordable ? { boxShadow: ['0 0 0px rgba(255, 92, 122,0)', '0 0 10px rgba(255, 92, 122,0.85)', '0 0 0px rgba(255, 92, 122,0)'] } : {}}
