#!/bin/bash
# Double-click THIS file in Finder to check your changes in the browser
# instantly, with no build and no deploy step. (macOS only treats .command
# files as double-clickable scripts — .sh files just open in a text editor.)
#
